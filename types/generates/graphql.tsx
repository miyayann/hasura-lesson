...
export type Profile_Users_Bool_Exp = {
  ...
  id?: Maybe<Uuid_Comparison_Exp>
  prifile_id?: Maybe<Uuid_Comparison_Exp>
...
export type Users_Bool_Exp = {
  ...
  users_group?: Maybe<Groups_Bool_Exp>
...
export type Users_Insert_Input = {
  ...
  name?: Maybe<Scalars['String']>
  profile_id?: Maybe<Scalars['uuid']>
  users_group?: Maybe<Groups_Obj_Rel_Insert_Input>
...
export type Users_Order_By = {
  ...
  name?: Maybe<Order_By>
  profile_id?: Maybe<Order_By>
  users_group?: Maybe<Groups_Order_By>
...
export const UpdateUserDocument = gql`
  mutation UpdateUser($id: uuid!, $name: String) {
    update_users_by_pk(_set: { name: $name }, pk_columns: { id: $id }) {
      id
      name
      created_at
    }
